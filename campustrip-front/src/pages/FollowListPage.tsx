...
function FollowListPage() {
  ...
  return (
    <PageContainer>
      ...
      <TabMenu>
        <TabButton active={activeTab === 'followers'} onClick={() => setActiveTab('followers')}>팔로워</TabButton>
        <TabButton active={activeTab === 'followings'} onClick={() => setActiveTab('followings')}>팔로잉</TabButton>
        <TabButton active={activeTab === 'recommendations'} onClick={() => setActiveTab('recommendations')}>검색</TabButton>
      </TabMenu>
      <UserList>
        {renderList()}
      </UserList>
