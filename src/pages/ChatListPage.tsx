...
// --- 임시 데이터 ---
const dummyChats = [
  { id: 1, userName: '제주도 여행', lastMessage: '사진 너무 잘 찍어주셔서 감사해요!', timestamp: '오후 2:30' },
  { id: 2, userName: '홍길동', lastMessage: '네, 그럼 그때 뵐게요!', timestamp: '7월 6일' },
  { id: 3, userName: '김철수', lastMessage: '혹시 일정 변경 가능할까요?', timestamp: '7월 3일' },
];
